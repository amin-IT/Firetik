...
and translates it to RouterOs script. I host the script at http://aminfiretik.hstn.me/firehol/firehol.rsc. 
...
/tool fetch url="http://aminfiretik.hstn.me/firehol/firehol.rsc" mode=http;
}
